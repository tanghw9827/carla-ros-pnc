...
struct CarlaTrafficLightInfoList_
{
  ...
  using _traffic_lights_type =
    std::vector<carla_msgs::msg::CarlaTrafficLightInfo_<ContainerAllocator>, typename ContainerAllocator::template rebind<carla_msgs::msg::CarlaTrafficLightInfo_<ContainerAllocator>>::other>;
  _traffic_lights_type traffic_lights;

  // setters for named parameter idiom
  Type & set__traffic_lights(
    const std::vector<carla_msgs::msg::CarlaTrafficLightInfo_<ContainerAllocator>, typename ContainerAllocator::template rebind<carla_msgs::msg::CarlaTrafficLightInfo_<ContainerAllocator>>::other> & _arg)
  {
