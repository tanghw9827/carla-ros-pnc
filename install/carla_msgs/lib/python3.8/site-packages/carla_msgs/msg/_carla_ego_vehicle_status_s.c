...
bool carla_msgs__msg__carla_ego_vehicle_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carla_msgs.msg._carla_ego_vehicle_status.CarlaEgoVehicleStatus", full_classname_dest, 62) == 0);
  }
  carla_msgs__msg__CarlaEgoVehicleStatus * ros_message = _ros_message;
  {  // header
  ...
  {  // control
    ...
    if (!carla_msgs__msg__carla_ego_vehicle_control__convert_from_py(field, &ros_message->control)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of CarlaEgoVehicleStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("carla_msgs.msg._carla_ego_vehicle_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CarlaEgoVehicleStatus");
  ...
  {  // control
    PyObject * field = NULL;
    field = carla_msgs__msg__carla_ego_vehicle_control__convert_to_py(&ros_message->control);
    if (!field) {
      return NULL;
    }
    {
