...
bool carla_ackermann_msgs__msg__ego_vehicle_control_target__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carla_ackermann_msgs.msg._ego_vehicle_control_target.EgoVehicleControlTarget", full_classname_dest, 76) == 0);
  }
  carla_ackermann_msgs__msg__EgoVehicleControlTarget * ros_message = _ros_message;
  {  // steering_angle
...
{
  /* NOTE(esteve): Call constructor of EgoVehicleControlTarget */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("carla_ackermann_msgs.msg._ego_vehicle_control_target");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EgoVehicleControlTarget");
