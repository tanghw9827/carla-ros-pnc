...
#ifndef CARLA_ACKERMANN_MSGS__MSG__EGO_VEHICLE_CONTROL_STATUS_H_
#define CARLA_ACKERMANN_MSGS__MSG__EGO_VEHICLE_CONTROL_STATUS_H_
...
#endif  // CARLA_ACKERMANN_MSGS__MSG__EGO_VEHICLE_CONTROL_STATUS_H_
