...
bool carla_ros_scenario_runner_types__msg__carla_scenario_runner_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("carla_ros_scenario_runner_types.msg._carla_scenario_runner_status.CarlaScenarioRunnerStatus", full_classname_dest, 91) == 0);
  }
  carla_ros_scenario_runner_types__msg__CarlaScenarioRunnerStatus * ros_message = _ros_message;
  {  // status
...
{
  /* NOTE(esteve): Call constructor of CarlaScenarioRunnerStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("carla_ros_scenario_runner_types.msg._carla_scenario_runner_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CarlaScenarioRunnerStatus");
