...
static const _EgoVehicleControlMaxima_type_support_symbol_names_t _EgoVehicleControlMaxima_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, carla_ackermann_msgs, msg, EgoVehicleControlMaxima)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carla_ackermann_msgs, msg, EgoVehicleControlMaxima)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, carla_ackermann_msgs, msg, EgoVehicleControlMaxima)() {
  return &::carla_ackermann_msgs::msg::rosidl_typesupport_c::EgoVehicleControlMaxima_message_type_support_handle;
}
