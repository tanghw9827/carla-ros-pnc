...
static const _EgoVehicleControlCurrent_type_support_symbol_names_t _EgoVehicleControlCurrent_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carla_ackermann_msgs, msg, EgoVehicleControlCurrent)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, carla_ackermann_msgs, msg, EgoVehicleControlCurrent)),
  }
};
...
{
  return &::carla_ackermann_msgs::msg::rosidl_typesupport_cpp::EgoVehicleControlCurrent_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, carla_ackermann_msgs, msg, EgoVehicleControlCurrent)() {
  return get_message_type_support_handle<carla_ackermann_msgs::msg::EgoVehicleControlCurrent>();
}
