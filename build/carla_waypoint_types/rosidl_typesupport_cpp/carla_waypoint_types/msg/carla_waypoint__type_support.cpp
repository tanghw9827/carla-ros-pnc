...
static const _CarlaWaypoint_type_support_symbol_names_t _CarlaWaypoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carla_waypoint_types, msg, CarlaWaypoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, carla_waypoint_types, msg, CarlaWaypoint)),
  }
};
...
{
  return &::carla_waypoint_types::msg::rosidl_typesupport_cpp::CarlaWaypoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, carla_waypoint_types, msg, CarlaWaypoint)() {
  return get_message_type_support_handle<carla_waypoint_types::msg::CarlaWaypoint>();
}
