...
void GetActorWaypoint_Request__rosidl_typesupport_introspection_c__GetActorWaypoint_Request_init_function(
...
void GetActorWaypoint_Request__rosidl_typesupport_introspection_c__GetActorWaypoint_Request_fini_function(void * message_memory)
{
  carla_waypoint_types__srv__GetActorWaypoint_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GetActorWaypoint_Request__rosidl_typesupport_introspection_c__GetActorWaypoint_Request_message_member_array[1] = {
  {
    "id",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers GetActorWaypoint_Request__rosidl_typesupport_introspection_c__GetActorWaypoint_Request_message_members = {
  ...
  GetActorWaypoint_Request__rosidl_typesupport_introspection_c__GetActorWaypoint_Request_message_member_array,  // message members
  GetActorWaypoint_Request__rosidl_typesupport_introspection_c__GetActorWaypoint_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  GetActorWaypoint_Request__rosidl_typesupport_introspection_c__GetActorWaypoint_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetActorWaypoint_Request__rosidl_typesupport_introspection_c__GetActorWaypoint_Request_message_type_support_handle = {
  0,
  &GetActorWaypoint_Request__rosidl_typesupport_introspection_c__GetActorWaypoint_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carla_waypoint_types, srv, GetActorWaypoint_Request)() {
  if (!GetActorWaypoint_Request__rosidl_typesupport_introspection_c__GetActorWaypoint_Request_message_type_support_handle.typesupport_identifier) {
    GetActorWaypoint_Request__rosidl_typesupport_introspection_c__GetActorWaypoint_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetActorWaypoint_Request__rosidl_typesupport_introspection_c__GetActorWaypoint_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void GetActorWaypoint_Response__rosidl_typesupport_introspection_c__GetActorWaypoint_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void GetActorWaypoint_Response__rosidl_typesupport_introspection_c__GetActorWaypoint_Response_fini_function(void * message_memory)
{
  carla_waypoint_types__srv__GetActorWaypoint_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GetActorWaypoint_Response__rosidl_typesupport_introspection_c__GetActorWaypoint_Response_message_member_array[1] = {
  {
    "waypoint",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers GetActorWaypoint_Response__rosidl_typesupport_introspection_c__GetActorWaypoint_Response_message_members = {
  "carla_waypoint_types__srv",  // message namespace
  "GetActorWaypoint_Response",  // message name
  1,  // number of fields
  sizeof(carla_waypoint_types__srv__GetActorWaypoint_Response),
  GetActorWaypoint_Response__rosidl_typesupport_introspection_c__GetActorWaypoint_Response_message_member_array,  // message members
  GetActorWaypoint_Response__rosidl_typesupport_introspection_c__GetActorWaypoint_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  GetActorWaypoint_Response__rosidl_typesupport_introspection_c__GetActorWaypoint_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetActorWaypoint_Response__rosidl_typesupport_introspection_c__GetActorWaypoint_Response_message_type_support_handle = {
  0,
  &GetActorWaypoint_Response__rosidl_typesupport_introspection_c__GetActorWaypoint_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, carla_waypoint_types, srv, GetActorWaypoint_Response)() {
  GetActorWaypoint_Response__rosidl_typesupport_introspection_c__GetActorWaypoint_Response_message_member_array[0].members_ =
  ...
  if (!GetActorWaypoint_Response__rosidl_typesupport_introspection_c__GetActorWaypoint_Response_message_type_support_handle.typesupport_identifier) {
    GetActorWaypoint_Response__rosidl_typesupport_introspection_c__GetActorWaypoint_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetActorWaypoint_Response__rosidl_typesupport_introspection_c__GetActorWaypoint_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
