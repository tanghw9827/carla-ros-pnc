...
static const _CarlaScenarioList_type_support_symbol_names_t _CarlaScenarioList_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carla_ros_scenario_runner_types, msg, CarlaScenarioList)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, carla_ros_scenario_runner_types, msg, CarlaScenarioList)),
  }
};
...
{
  return &::carla_ros_scenario_runner_types::msg::rosidl_typesupport_cpp::CarlaScenarioList_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, carla_ros_scenario_runner_types, msg, CarlaScenarioList)() {
  return get_message_type_support_handle<carla_ros_scenario_runner_types::msg::CarlaScenarioList>();
}
